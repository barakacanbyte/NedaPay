...
async function main() {
  ...
  // Deploy a test ERC20 token for collateral
  ...
  try {
    ...
    await hre.run("verify:verify", {
      ...
      constructorArguments: [tshcAddress, deployer.address],
    });
